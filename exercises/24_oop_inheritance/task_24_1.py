...
class CiscoSSH(BaseSSH):
    def __init__(self, **new_dict): # 2 - запаковываем в новый словарь
        print(id(new_dict))
        print(new_dict.keys()) # 3 - ключи нового словаря
        print(new_dict.values()) # 4 - значения
        super().__init__(**new_dict) # 5 - распаковываем новый словарь
        self.ssh.enable()
...
if __name__ == "__main__":
    ...
    print(id(device_params))
    r1 = CiscoSSH(**device_params) # 1 - распаковываем
    print(r1.ssh.find_prompt())
